    ...
    <div class="table-container">
        <table class="data-table" id="tablaMateriales">
            ...
            <tbody>
                ...
                <tr data-id="{{ $item->id }}" data-familia-id="{{ $item->material_familia_id }}" data-descripcion="{{ e($item->descripcion) }}" data-marca-id="{{ $item->material_marca_id }}" data-modelo-id="{{ $item->material_modelo_id }}" data-stock="{{ $item->stock }}">
                    <td>{{ $item->id }}</td>
...
<div id="modalMaterialItem" class="modal-overlay" aria-hidden="true" style="z-index: 120000;">
    <div class="modal-sector hm-modal">
        ...
        <form id="formMaterialItem" method="POST" class="modal-sector-body">
            @csrf
            ...
            <div class="form-grupo">
                ...
                <input type="text" id="materialDescripcion" name="descripcion" required maxlength="180" autocomplete="off">
            </div>
            <div class="form-grupo">
